<?php
    ...
    class Messaging {
         ...
         * @return string
        */
        public function sendEmail(string $login, string $password, string $emailAdress, string $subject, string $body, string|null $contactFirstName, string|null $contactLastName):string {
            ...
            try {
                ...
                $mail->SMTPSecure  = PHPMailer::ENCRYPTION_SMTPS;            // Enable implicit TLS encryption //! PHPMailer::ENCRYPTION_SMTPS ave ovh et port 465
                $mail->Port        = 465;                                    // TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
                //? Définir les expéditeurs/destinataires
                $mail->setFrom($login, mb_convert_encoding('Cécilia Orsi Coaching', 'ISO-8859-1', 'UTF-8'));                                // Adresse de l'expéditeur + alias qui apparait dans la boite du destinataire
