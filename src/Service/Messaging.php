<?php
    ...
    class Messaging {
        ...
        public function sendEmail(string $login, string $password, string $emailAdress, string $subject, string $body, string|null $contactFirstName, string|null $contactLastName) {
            ...
            try {
                ...
                $mail->SMTPSecure  = PHPMailer::ENCRYPTION_STARTTLS;            // Enable implicit TLS encryption //! PHPMailer::ENCRYPTION_SMTPS ave ovh et port 465
